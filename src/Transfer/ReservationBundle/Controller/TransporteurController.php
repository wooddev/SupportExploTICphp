...
use Transfer\ReservationBundle\Entity\Transporteur;
use Transfer\ReservationBundle\Form\TransporteurType;
...
class TransporteurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TransferReservationBundle:Transporteur')->findAll();

        return $this->render('TransferReservationBundle:Transporteur:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TransferReservationBundle:Transporteur')->find($id);
        ...
        return $this->render('TransferReservationBundle:Transporteur:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('TransferReservationBundle:Transporteur:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('TransferReservationBundle:Transporteur:edit.html.twig', array(
            'entity'      => $entity,
