...
use Explotic\AgendaBundle\Entity\CreneauRdv;
use Explotic\AgendaBundle\Form\CreneauRdvType;
...
class CreneauRdvController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExploticAgendaBundle:CreneauRdv')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExploticAgendaBundle:CreneauRdv')->find($id);
        ...
        return $this->render('ExploticAgendaBundle:CreneauRdv:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('ExploticAgendaBundle:CreneauRdv:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ExploticAgendaBundle:CreneauRdv:edit.html.twig', array(
            'entity'      => $entity,
